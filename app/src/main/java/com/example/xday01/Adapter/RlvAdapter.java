...
public class RlvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RlvAdapter(Context context, ArrayList<ProjectBean.ListBean> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.mTvTitle.setText(list.get(position).getDescription());
        Glide.with(context).load(list.get(position).getImage_url()).into(viewHolder.mTvRlv);
    }
